...
from ..flashface.all_finetune import ops
...
class FlashFaceLoadModel:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                "selected_model": (sorted(os.listdir(models_dir)), "str", "The model to load"),
            },
        }
    ...
    def load_models(self, flashface_path):
        ...
        model_weight = torch.load(flashface_path, map_location='cpu')
        ...
        return (autoencoder, flashface_model, diffusion,)